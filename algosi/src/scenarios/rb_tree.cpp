...
namespace Scenarios {
	...
	Task<Algorithms::RB_TREE>::Task(std::string name, const toml::table& table) : TaskBase(name, table)  {
		auto& tree = this->tree;
	...
	void Task<Algorithms::RB_TREE>::print_input() {

	}
	void Task<Algorithms::RB_TREE>::run() {
		lua.runtime.script(script);
	}
	void Task<Algorithms::RB_TREE>::print_output() {
